 ...
 * instead of midnight — for example `2026-08-18T09:00:00+05:30`.
 *
 ...
 */
export const LAUNCH_AT = new Date("2026-08-18T00:00:00+05:30");

/** Shown alongside the countdown. Must name the same day as `LAUNCH_AT`. */
export const LAUNCH_DATE_LABEL = "18 August 2026";
